...
def load_data(data, cpu_files, DPU_files):
...
k_data={
    "title":"varing_#centroids_dimension",
    "x_name":"#centroids",
    "x_axis":["5", "10", "20"],
    "CPU":np.zeros(3),
...
dim_data={
    ...
    "DPU_MASTER":np.array([2.245323657989501953e+02/1000, 0, 0]),
...
num_data={
    ...
    "DPU_MASTER":np.array([1.108753681182861328e+02/1000, 0, 0]),
}
...
def plot_res(data):
    ...
    bar3 = ax.bar(x_pos - line_width + line_width*2, data["DPU_MASTER"], width=line_width, edgecolor='k', color=colors[10])
...
if __name__=="__main__":
    dir = "results/"
    load_data(dim_data, [dir+ i for i in ["cpu_5_1000000_10.csv", "cpu_10_1000000_10.csv", "cpu_20_1000000_10.csv"]], [dir+i for i in ["framework_2546_5_1000000_10", "framework_2546_10_1000000_10", "framework_2546_20_1000000_10"]])
    plot_res(dim_data)
    load_data(num_data, [dir+ i for i in ["cpu_10_100000_10.csv", "cpu_10_1000000_10.csv", "cpu_10_10000000_10.csv"]], [dir+i for i in ["framework_2546_10_100000_10", "framework_2546_10_1000000_10", "framework_2546_10_10000000_10"]])
    plot_res(num_data)
    load_data(num_dpus_data, [], [dir+i for i in ["framework_128_10_1000000_10", "framework_512_10_1000000_10", "framework_2048_10_1000000_10"]])
    plot_res(num_dpus_data)
    load_data(k_data, [dir+ i for i in ["cpu_10_1000000_5.csv", "cpu_10_1000000_10.csv", "cpu_10_1000000_20.csv"]], [dir+i for i in ["framework_2523_10_1000000_5", "framework_2546_10_1000000_10", "framework_2546_10_1000000_20"]])
    plot_res(k_data)
